...
function Home() {
  return (
    <div>
          ...
          <div className="col-md-4 col-sm-12">
            <Item>
              ...
              <Description className="text-md-start">
                Proporcionar bem-estar e qualidade de vida por meio da massagem terapêutica, contribuindo para o equilíbrio físico, mental e emocional dos nossos clientes.
              </Description>
            </Item>
          </div>
          <div className="col-md-4 col-sm-12">
            <Item>
              ...
              <Text>Visão</Text>
              <Description className="text-md-start">
                Ser referência em massagem terapêutica, reconhecida pela excelência no atendimento e na capacitação dos nossos profissionais.
              </Description>
            </Item>
          </div>
          <div className="col-md-4 col-sm-12">
            <Item>
              ...
              <Text>Valores</Text>
              <Description className="text-md-start">
              Ética e transparência nas relações, respeito à diversidade e inclusão, compromisso com a qualidade e atualização constante, responsabilidade socioambiental.
              </Description>
            </Item>
          </div>
        </div>
      ...
      <div className="container mx-auto my-5" style={{fontFamily:"Roboto Slab"}}>
        <div className="row">
          <div className="col-12">
            <h1 className="text-center">Tipos de Terapias</h1>
          </div>
        </div>
        <div className="row">
          <div className="col-lg-4 col-md-6 col-sm-12 col-12 my-4">
            <Cards
